...
import '../AppointmentsAndConsultations/appointment_user_model.dart';
import '../circular_image.dart';
import '../utils/constants/colors.dart';
import '../utils/constants/sizes.dart';
import '../utils/helpers/helper_functions.dart';
class UpcomingandPastAppointments extends StatefulWidget {
  const UpcomingandPastAppointments({super.key});


  @override
  State<UpcomingandPastAppointments> createState() => _UpcomingandPastAppointmentsState();
}

class _UpcomingandPastAppointmentsState extends State<UpcomingandPastAppointments> {
          ...
          children: [
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  stream: _db.collection("Patients").where('DoctorID',isEqualTo: _auth.authUser!.uid).where('Status',isEqualTo: status).snapshots(),
